...
Source0:        http://downloads.sourceforge.net/project/virtualgl/%{version}/VirtualGL-%{version}.tar.gz
# fix for bz1088475
...
fgrep -rl --include="*.[ch]*" "glx.h" . | xargs sed -i \
         -e 's,"glx.h",<GL/glx.h>,' \
         -e 's,"../common/glx.h",<GL/glx.h>,' \
         -e 's,"../common/glxext.h",<GL/glxext.h>,'
...
#mv $RPM_BUILD_ROOT%{_libdir}/*.so $RPM_BUILD_ROOT%{_libdir}/VirtualGL/
...
%changelog
* Thu May 03 2018 Timothy Redaelli <tredaelli@redhat.com> - 2.5.2-0.1
- Update to 2.5.2
