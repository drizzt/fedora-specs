...
Name: dpdk-rc
Version: 17.05
Release: 0.1.%{vd_rc}%{?dist}
URL: http://dpdk.org
Source: http://dpdk.org/browse/dpdk/snapshot/dpdk-%{version}-%{vd_rc}.tar.xz
Patch0: http://dpdk.org/dev/patchwork/patch/20501/mbox/#/examples-ethtool-ethtool-app-libfix.patch
...
BuildArch: noarch
Provides: dpdk-doc = %{version}-%{release}
Obsoletes: dpdk-doc
...
Provides: dpdk-tools = %{version}-%{release}
Obsoletes: dpdk-tools
...
Provides: dpdk-examples = %{version}-%{release}
Obsoletes: dpdk-examples
...
%changelog
* Fri Apr 07 2017 Timothy Redaelli <tredaelli@redhat.com> - 17.05-0.1.rc1
- Update to 17.05-rc1
